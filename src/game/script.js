...
function changeData(indexOfBoardPiece, modifiedIndex, removePiece) {
    ...
    if (removePiece) {
        ...
        if (turn && selectedPiece.pieceId < 12) {
            ...
            blackScore--
            document.getElementById("redS").stepUp();
        }
        if (turn === false && selectedPiece.pieceId >= 12) {
            cells[removePiece].innerHTML = "";
            redScore--
            document.getElementById("blackS").stepUp();
        }
        checker(modifiedIndex);
        if (flag) {
            flag = false;
            //removeEventListenersMulti(modifiedIndex);
...
//checks to see if after a move there is more jumps to be had
function checker(modifiedIndex) {
    if (turn) {
        if ((board[modifiedIndex + 14] === null
            && cells[modifiedIndex + 14].classList.contains("noPieceHere") !== true
            && board[modifiedIndex + 7] >= 12
            && modifiedIndex < 48) || (board[modifiedIndex + 18] === null
            && cells[modifiedIndex + 18].classList.contains("noPieceHere") !== true
            && board[modifiedIndex + 9] >= 12
            && modifiedIndex < 48) || (board[modifiedIndex - 14] === null
            && cells[modifiedIndex - 14].classList.contains("noPieceHere") !== true
            && board[modifiedIndex - 7] >= 12
            && modifiedIndex < 48 && cells[modifiedIndex].classList.contains("red-piece king") === true) || 
            (board[modifiedIndex - 18] === null
            && cells[modifiedIndex - 18].classList.contains("noPieceHere") !== true
            && board[modifiedIndex - 9] >= 12
            && modifiedIndex < 48 && cells[modifiedIndex].classList.contains("red-piece king") === true)) {
            flag = true;
        ...
        if ((board[modifiedIndex + 14] === null
            && cells[modifiedIndex + 14].classList.contains("noPieceHere") !== true
            && board[modifiedIndex + 7] < 12 && board[modifiedIndex + 7] !== null
            && modifiedIndex > 14 && cells[modifiedIndex].classList.contains("black-piece king") === true) || (board[modifiedIndex + 18] === null
            && cells[modifiedIndex + 18].classList.contains("noPieceHere") !== true
            && board[modifiedIndex + 9] < 12 && board[modifiedIndex + 9] !== null
            && modifiedIndex > 14 && cells[modifiedIndex].classList.contains("black-piece king") === true) || (board[modifiedIndex - 14] === null && cells[modifiedIndex - 14].classList.contains("noPieceHere") !== true
            && board[modifiedIndex - 7] < 12
            && board[modifiedIndex - 7] !== null
            && modifiedIndex > 14) || (board[modifiedIndex - 18] === null && cells[modifiedIndex - 18].classList.contains("noPieceHere") !== true
            && board[modifiedIndex - 9] < 12
            && board[modifiedIndex - 9] !== null
            && modifiedIndex > 14)) {
            flag = true;
            }
        }
...
function removeEventListenersMulti(modifiedIndex) {
    if (turn) {
        for (let i = 0; i < redsPieces.length; i++) {
